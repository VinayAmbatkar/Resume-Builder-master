...
const testimonials = [
    {
        name: 'Vinay Sanjay Ambatkar',
        role: 'Fronted Web Developer || Software Devloper',
        content:
            'A resume builder website iAn ATS-friendly resume is designed to pass through Applicant Tracking Systems, ensuring that your resume reaches human recruiters. A resume builder website is an online platform designed to help users craft and personalize professional resumes effortlessly. These platforms usually offer a variety of templates and customization options, enabling users to tailor their resumes to meet their specific needs and career goals while ensuring it remains optimized for ATS.s a web-based tool that allows users to create and customize a professional resume to their desired specifications. These websites typically provide templates for creating a resume.',
        avatar:
            'https://media.licdn.com/dms/image/v2/D5603AQGtt5O5UVf_Zw/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1681630427312?e=1732752000&v=beta&t=XbFFq7fC-77FJd5FK-H27WKFOLMfti3ojvYndLRtlUo',
    }
];
